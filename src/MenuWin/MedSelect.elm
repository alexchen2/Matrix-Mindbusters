module MenuWin.MedSelect exposing (..)
...
numLevels = 4   -- ** --
levelPrefix = "M"             -- "E" for Easy, "M" for Medium, "H" for Hard
...
-- Originally intended to make module more dynamic and choose from Medium, Medium, or Hard, but scrapped that idea
