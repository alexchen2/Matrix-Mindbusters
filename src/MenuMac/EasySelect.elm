module MenuMac.EasySelect exposing (..)
...
import Misc.LvlImgs exposing ( easyLevel1, easyLevel2, easyLevel3
                             , easyLevel4, easyLevel5, easyLevel6
                             , easyLevel7, easyLevel8, easyLevel9
                             , easyLevel10, easyLevel11 )

{- ** Constants ** -}
-- Change below two constants (and some alg data types below) to switch menu for different difficulties
numLevels = 11
levelPrefix = "E"             -- "E" for Easy, "M" for Medium, "H" for Hard
...
titleFont = "Arial"  -- alternative for non-Windows: Arial
descTextFont = "Arial Light"
timeFont = "Calibri Heavy"

levelImgList = [ easyLevel1, easyLevel2, easyLevel3
               , easyLevel4, easyLevel5, easyLevel6
               , easyLevel7, easyLevel8, easyLevel9
               , easyLevel10, easyLevel11 ] 
...
-- Originally intended to make module more dynamic and choose from Easy, Medium, or Easy, but scrapped that idea
type Level = Easy Int
           | LevelNone
...
init = { time = 0 
       ...
       , click = ClickNone
       , levelDisplay = Easy 1
       , prevLevelDisplay = Easy 1   -- LevelNone
       , levelChoose = LevelNone       
       , winState = Opening 
       , isExit = False }

main = gameApp Tick { model = init, view = view, update = update, title = "MM | Select a Easy Level" }
